...
/** Catalogue marques / modèles courants (marché sénégalais + flotte). */
const CATALOGUE: Record<string, string[]> = {
  Toyota: ['Corolla', 'Hilux', 'RAV4', 'Land Cruiser', 'Yaris', 'Fortuner', 'Prado', 'Camry', 'Avanza', 'Coaster'],
  Hyundai: ['Tucson', 'Accent', 'Santa Fe', 'i10', 'Creta', 'Elantra', 'Palisade', 'H1', 'Porter'],
  Peugeot: ['208', '301', '308', '2008', '3008', '5008', 'Partner', 'Boxer', 'Landtrek'],
  Renault: ['Duster', 'Clio', 'Megane', 'Logan', 'Captur', 'Kadjar', 'Trafic', 'Master', 'Express'],
  Kia: ['Sportage', 'Picanto', 'Rio', 'Sorento', 'Seltos', 'Cerato', 'Carnival'],
  Nissan: ['Qashqai', 'Patrol', 'Navara', 'Micra', 'X-Trail', 'Juke', 'Urvan'],
  Mercedes: ['Classe A', 'Classe C', 'Classe E', 'GLE', 'GLC', 'Sprinter', 'Vito', 'Classe G'],
  BMW: ['Série 1', 'Série 3', 'Série 5', 'X1', 'X3', 'X5', 'X6'],
  Volkswagen: ['Golf', 'Polo', 'Tiguan', 'Passat', 'Amarok', 'Caddy', 'Transporter'],
  Ford: ['Ranger', 'Focus', 'Everest', 'EcoSport', 'Transit', 'Explorer'],
  Suzuki: ['Swift', 'Jimny', 'Vitara', 'Alto', 'S-Cross', 'Ertiga'],
  ...
  Isuzu: ['D-Max', 'mu-X'],
  Geely: ['Coolray', 'Azkarra', 'Okavango', 'GX3 Pro'],
